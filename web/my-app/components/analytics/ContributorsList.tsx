    ...
    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6">
      ...
      <div className="space-y-1">
        {visible.map((contributor) => {
          const barWidth =
            (contributor.commits / Math.max(contributors[0]?.commits || 1, 1)) *
            100;
          ...
          return (
            ...
            >
              ...
              {contributor.avatar_url ? (
                ...
                <div className="w-6 h-6 bg-zinc-300 dark:bg-zinc-700 flex items-center justify-center text-xs font-bold text-zinc-600 dark:text-zinc-400">
